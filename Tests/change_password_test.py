...
class TestChangePassword:
    def __change_password_setup(self):
        ...
        account(self).go_to_change_password_page()
    ...
    def test_change_password_invalid_new_password_with_lower_case_only(self):
        ...
        change_password(self).fill_form_submit(current_password, invalid_password, invalid_password)
    ...
    def test_change_password_too_short_new_password(self):
        ...
        change_password(self).fill_form_submit(current_password, new_password, confirm_new_password)
