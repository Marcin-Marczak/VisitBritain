...
class AddNewAddressPage:
    def __init__(self, driver):
        ...
        self.add_new_address_page_street_address_line1_input = (By.ID, "street_1")
        self.add_new_address_page_street_address_line2_input = (By.ID, "street_2")
    ...
    def add_new_address_page_fill_the_form(self, phone_number, street_address_line1, street_address_line2,
                                           country_value, city, postcode):
        self.driver.find_element(*self.add_new_address_page_phone_number_input).send_keys(phone_number)
        self.driver.find_element(*self.add_new_address_page_street_address_line1_input).send_keys(street_address_line1)
        self.driver.find_element(*self.add_new_address_page_street_address_line2_input).send_keys(street_address_line2)
